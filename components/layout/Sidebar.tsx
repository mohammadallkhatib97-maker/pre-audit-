  ...
  return (
    <>
      ...
      <div style={{
        ...
        background: theme.navy, height: '56px',
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
          <div style={{ width: 32, height: 32, borderRadius: '8px', overflow: 'hidden', background: 'white', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
            <Image src="/logo.png" alt="Pioneers" width={28} height={28} style={{ objectFit: 'contain' }} />
          </div>
          <p style={{ color: 'white', fontWeight: '700', fontSize: '0.9rem', margin: 0 }}>Pioneers</p>
        </div>
        <button onClick={() => setMobileOpen(!mobileOpen)} style={{
          background: 'rgba(255,255,255,0.1)', border: '1px solid rgba(255,255,255,0.15)',
          borderRadius: '0.5rem', color: 'white', padding: '0.4rem 0.6rem',
      ...
      {mobileOpen && (
        <div
          ...
          style={{
            ...
            background: 'rgba(0,0,0,0.5)', zIndex: 48,
          }}
      ...
      <style>{`
        ...
        @media (min-width: 769px) {
          ...
          .desktop-sidebar { display: contents !important; }
        }
      `}</style>
    </>
  )
